...
_detalhes_database = {
	...
	["nick_tag_cache"] = {
		...
		["Ёс"] = {
			"Ёс", -- [1]
			"Interface\\EncounterJournal\\UI-EJ-BOSS-Lord Aurius Rivendare", -- [2]
			{
				0, -- [1]
				1, -- [2]
				0, -- [3]
	...
	["last_instance_time"] = 1578341187,
	["active_profile"] = "Зёба-Змейталак",
