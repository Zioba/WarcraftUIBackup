...
AUCTIONATOR_SHOPPING_LISTS = {
	{
		["items"] = {
			"Кровяной пир", -- [1]
			"Дренорское зелье невидимости", -- [2]
			"Зелье легкой поступи", -- [3]
			"Пироги с вороникой", -- [4]
			"Береговое лечебное зе", -- [5]
			"пыльца сирены", -- [6]
			"свиток стойкости", -- [7]
			"Боевое зелье силы", -- [8]
			"настой силы приб", -- [9]
			"Руда силового камня", -- [10]
			"Твердокаменная кожа", -- [11]
			"Шал'дорайский шелк", -- [12]
			"Штормовая чешуя", -- [13]
		},
		["isRecents"] = 1,
