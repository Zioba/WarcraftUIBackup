	...
	["filters"] = {
		{
			...
			["tooltip"] = "Отображение сообщений о действиях, совершенных вашим персонажем.",
			["name"] = "Мои действия",
			["colors"] = {
				["schoolColoring"] = {
					{
		...
		{
			["quickButtonName"] = "Что случилось с персонажем?",
			["onQuickBar"] = true,
			["quickButtonDisplay"] = {
				["party"] = true,
				["solo"] = true,
			...
			["tooltip"] = "Отображение всех действий в отношении вашего персонажа.",
			["name"] = "Что случилось с персонажем?",
			["colors"] = {
				["schoolColoring"] = {
					{
						["a"] = 1,
